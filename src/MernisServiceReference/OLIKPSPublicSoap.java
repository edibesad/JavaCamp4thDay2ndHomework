...
public class OLIKPSPublicSoap
{
    ...
    public OLIKPSPublicSoap()
    {
    }

    public OLIKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public OLIKPSPublicSoap(String url, int timeOut)
    {
        this.url = url;
    ...
    {
        OLIExtendedSoapSerializationEnvelope envelope = new OLIExtendedSoapSerializationEnvelope(OLIExtendedSoapSerializationEnvelope.VER11);
