...
public class ALKExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(ALKDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new ALKStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static ALKDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static ALKDateTimeConverter dateTimeConverter = new ALKStandardDateTimeConverter();

    public ALKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public ALKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new ALKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=ALKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,ALKExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=ALKHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
