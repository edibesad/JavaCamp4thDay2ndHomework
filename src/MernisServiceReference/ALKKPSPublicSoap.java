...
public class ALKKPSPublicSoap
{
    ...
    public ALKKPSPublicSoap(){}

    public ALKKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public ALKKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        ALKExtendedSoapSerializationEnvelope envelope= new ALKExtendedSoapSerializationEnvelope(ALKExtendedSoapSerializationEnvelope.VER11);
