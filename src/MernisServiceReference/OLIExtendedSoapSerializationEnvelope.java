...
public class OLIExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope
{
    ...
    public static void setDateTimeConverter(OLIDateTimeConverter converter)
    {
        if (converter == null)
        {
            dateTimeConverter = new OLIStandardDateTimeConverter();
        }
        dateTimeConverter = converter;
    }

    public static OLIDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static OLIDateTimeConverter dateTimeConverter = new OLIStandardDateTimeConverter();

    public OLIExtendedSoapSerializationEnvelope()
    {
        this(SoapEnvelope.VER11);
    }

    public OLIExtendedSoapSerializationEnvelope(int soapVersion)
    {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new OLIMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException
    {
        ...
        if (!type.multiRef && qName[2] == null)
        {
            ...
            {
                java.lang.String xmlName = OLIHelper.getKeyByValue(classNames, obj.getClass());
                if (xmlName != null)
                {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException
    {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap", Object.class, OLIExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName = OLIHelper.getKeyByValue(classNames, obj);
        if (xmlName == null)
        {
            return obj;
        }
